...
def update_user_agenda_job(job_queue, user_id: int, is_enabled: bool, time_str: str) -> None:
    """
    ...
    try:
        ...
        logger.error(f"Failed to parse time string '{time_str}' for user {user_id}: {e}")
        return
